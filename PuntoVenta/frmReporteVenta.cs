...
namespace PuntoVenta
{
    public partial class frmReporteVenta : Form
    {
        ...
        private void btnListar_Click(object sender, EventArgs e)
        {
            ...
            lista = new CN_Reporte().obtenerVentas(dateFechaInicio.Text.ToString(), dateFechaFinal.Text.ToString());
        ...
        private void btnDescargarExcel_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                archivoGuardado.FileName = string.Format("ReporteVentas_{0}.xlsx", DateTime.Now.ToString("ddmmyyyyHHmmss"));
