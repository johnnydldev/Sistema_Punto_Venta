...
namespace PuntoVenta
{
    public partial class frmCompras : Form
    {
        ...
        private void frmCompras_Load(object sender, EventArgs e)
        {
            ...
            this.btnBuscarProveedor.Cursor = _customHandCursor;
            this.btnCalcularPrecio.Cursor = _customHandCursor;
            ...
            this.txtPorcentaje.Cursor = _customCaretCursor;
            this.txtPrecioCompra.Cursor = _customCaretCursor;
